 ...
 */
@Stateless
@Path("bbdd.inventario")
public class InventarioFacadeREST extends AbstractFacade<Inventario> {

    @PersistenceContext(unitName = "TrabajoDeCursoWS2PU")
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Inventario entity) {
        super.edit(entity);
    }
    ...
    public Inventario find(@PathParam("id") Integer id) {
